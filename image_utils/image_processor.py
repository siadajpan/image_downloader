...
class Image_Processor:
    ...
    def cut(self, pixels):
        ...
        try:
            ...
            # get widht and height of image and check if region is correct
    ...
    def _create_higher_image(self, image, border):
    ...
    def _create_output_image(self):
        ...
        if self.processed_image is not None:
            ...
            if height_o > height_p:
                ...
                new_processed = self._create_higher_image(self.processed_image, 
                                                          border)
            else:
                new_original = self._create_higher_image(self.original_image, 
                                                         border)
